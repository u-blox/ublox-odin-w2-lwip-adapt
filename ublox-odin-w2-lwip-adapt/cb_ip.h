...
#define cbIP_SET_IP4_ADDR(address, a, b, c, d) \
    (address).value = ((cb_uint32)((d) & 0xff) << 24) | ((cb_uint32)((c) & 0xff) << 16) | ((cb_uint32)((b) & 0xff) << 8) | (cb_uint32)((a) & 0xff)

#define L2ROUTER_ACTIVE TRUE
/*===========================================================================
 * TYPES
 *=========================================================================*/
...
typedef void (*cbIP_statusIndication)(cbIP_Status status, void* callbackArg, cbIP_IPv4Settings const * const ipV4settings, cbIP_IPv6Settings const * const ipV6settings);

typedef void(*cbIP_addrResolvedCallback)(const char *name, cbIP_IPv4Address *ipaddr, void *hClient);
...
void cbIP_startUdpEchoServer(cb_uint16 port);
void cbIP_startTcpEchoServer(cb_uint16 port);
